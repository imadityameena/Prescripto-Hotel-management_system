// FILE: admin/src/pages/Doctor/DoctorProfile.jsx
...
const DoctorProfile = () => {
    ...
    // (76.1) Using state to toggle between displaying text and input field for appointment fee editing. ✅
    const [isEdit, setIsEdit] = useState(false)

    // (76.2) Updating and saving changes in the doctor appointment booking system. ✅
    // (76.3) Updating doctor profile data using MERN Stack ✅
    const updateProfile = async () => {
        try {
            ...
            if (data.success) {
                ...
                setIsEdit(false)
                getProfileData() // Refreshes data after update.
            } else {
    ...
    // (75.4) Fetching and displaying profile data for the logged-in doctor ✅
    useEffect(() => {
        if (dToken) {
            getProfileData()
        }
    ...
    return profileData && (
        <div>
            {/* // (75.5) Display doctor's information ✅ */}
            <div className='flex flex-col gap-4 m-5'>
                <div>
                    <img className='bg-primary/80 w-full sm:max-w-64 rounded-lg' src={profileData.image} alt="" />
                </div>
                {/* // (75.6) Adding CSS properties to the elements for styling ✅ */}
                <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
                    ...
                    <div>
                        ...
                        <p className='text-sm text-gray-600 max-w-[700px] mt-1'>
                            {/* // (76.4) Updating and editing data in the input field ✅ */}
                            {/* In edit mode, a textarea is shown. Otherwise, static text is displayed. */}
                            {
                                isEdit
                    ...
                    {/* // (76.5) Implement styling for various elements ✅ */}
                    ...
                    {/* // (114) Updating doctor availability status and styling the UI ✅ */}
